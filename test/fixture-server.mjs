...
import { gmailConnection, openrouterConnection, expoConnection } from '../src/providers/catalog.mjs';
...
const integrations = process.env.FOUNDATION_TEST_EXPO === '1' ? [expoConnection(new FakeExpo()), gmailConnection(gmail)] : process.env.FOUNDATION_TEST_OPENROUTER === '1' ? [openrouterConnection(new FakeOpenRouter()), gmailConnection(gmail)] : undefined;
