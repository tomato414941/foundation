...
export function guide(connectors) {
  return ['Foundation keeps user-controlled values and objects, and runs explicitly requested built-in functions.',
    ...
    'WHAT IS KEPT',
    '   PUT /v1/secrets?name=<name>    body: raw bytes, up to 1MB. The same exact name replaces that value.',
    ...
    '   GET /v1/secrets    ids, names, sizes and timestamps, not contents.',
    '   GET /v1/secrets?prefix=<literal prefix>   optional case-sensitive text filtering, not a directory.',
    '   GET /v1/secrets?name=<name>               bytes, as written; 403 forbidden without a line to it.',
