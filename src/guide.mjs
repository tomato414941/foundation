...
export function guide(adapters) {
  return ['Foundation is a store. It keeps what belongs to its owner, and hands it to the commands they run.',
    ...
    'THE STORE',
    '   PUT /v1/secrets/<path>?env=NAME&filename=NAME&secret=true&if_version=N',
    ...
    '   GET /v1/secrets?prefix=<path prefix>   what is kept: paths, media types, sizes, how each is delivered, version, who wrote it.',
