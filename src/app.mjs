    ...
    try {
      ...
      if (path === '/v1/access-requests' || path === '/v1/access-requests/current') {
        ...
        if (path === '/v1/access-requests' && method === 'POST') {
          ...
          return send(201, { request: requests.summary(requests.create(token, { name, purpose, provider: input.provider, mode: input.mode, details: input.details, guidance: input.guidance ?? '' }), origin) });
        }
