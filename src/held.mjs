...
export function held({ environment = {}, files = [], session = null, facts = {}, renewal = {}, expires_at = null, expiry_known = true, credential_type = 'api_key', scopes }) {
  ...
  return { environment, files, session, facts, renewal, expires_at, expiry_known, credential_type, ...(scopes ? { scopes } : {}) };
}
