...
import { gmailConnection, openrouterConnection, expoConnection } from './providers/catalog.mjs';
...
const app = createApp({ database: config.database, encryptionKey: config.encryptionKey, publicOrigin: config.publicOrigin, auth, gmail, integrations: [openrouterConnection(openrouter), expoConnection(new ExpoProvider(config.expo)), gmailConnection(gmail)] });
