...
// Names that built-in adapters already own; a runtime-declared field may not borrow them.
const ADAPTER_PREFIX = /^(GOOGLE_OAUTH_|GMAIL_|OPENROUTER_|EXPO_|SUPABASE_ACCESS_TOKEN$|CLOUDFLARE_|CF_API_|AWS_)/;
...
export function validRequestedEnvName(value) {
  return validEnvName(value) && !ADAPTER_PREFIX.test(value);
}
